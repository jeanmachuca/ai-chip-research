...
\title{Hardware Acceleration of Q4\_0-Quantized llama-3.2-1b-q4\_0 Inference}
...
- \texttt{axi4\_master}: AXI4 bus interface for DMA transfers
- \texttt{block\_unpacker}: Parses packed quantized weight blocks
- \texttt{gguf\_q4\_0\_dequantizer}: Converts Q4\_0 format to FP16
- \texttt{pe\_array\_systolic}: Systolic engine for GEMV operations
