...
The current dequantizer implements the Q4\_0 scheme; the module interface is structured so that additional GGUF block formats (Q8\_0, Q4\_K) can be added with the same scale-offset pattern.
